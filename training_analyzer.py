...
# 今回の競馬場×コースで実績がない場合「近いコース」の実績で補う用途。
# 系統: 左回り瞬発(東京/中京/新潟外) / 右回り瞬発(阪神外/京都外) /
#       右回りパワー(中山/阪神内/京都内) / 小回り先行(札幌/函館/福島/小倉/新潟内)

# (競馬場コード, track_code) → コース名
_COURSE_NAME = {
    ("01", "17"): "札幌", ("02", "17"): "函館", ("03", "17"): "福島", ("10", "17"): "小倉",
    ("04", "11"): "新潟外", ("04", "12"): "新潟内", ("04", "10"): "新潟直線",
    ("05", "11"): "東京", ("07", "11"): "中京",
    ("06", "17"): "中山内", ("06", "18"): "中山外",
    ("08", "17"): "京都内", ("08", "18"): "京都外",
    ("09", "17"): "阪神内", ("09", "18"): "阪神外",
...
def _course_name(keibajo_code, track_code) -> str | None:
    """(競馬場コード, track_code) → コース名（内外区別）。芝のみ。"""
    return _COURSE_NAME.get((str(keibajo_code or "").zfill(2),
                             str(track_code or "").strip()))


def _similar_courses(course_name: str) -> list[str]:
    """コース名 → 近いコース名リスト（近い順）。"""
    return _COURSE_SIMILAR.get(course_name, [])
